...
// উদাহরণ২ঃ  যদি ২৩৫ জন মানুষ পিকনিকে যায় তাহলে আমাদের বাস লাগবে ৪ টি ও মাইক্রোবাস লাগবে ৩ টি এবং বাকি মানুষ পাবলিক বাসে যাবে। এই কয়জন মানুষগুলোর জন্য পাবলিক বাসের ভাড়া মোট কত হবে সেটি রিটার্ন করতে হবে।

// Sample Data
// Input: 50 55 112 235 365
// Output: 0 1250 250 500 1000


function publicBusFare(values) {
    ...
    for (let i = 0; i < values.length; i++) {
        ...
        if (value >= busCapacity) {
            a = value % busCapacity;
            b = a % microCapacity;
            c = b * publicBusTicketPrice;
        }
        arr.push(c);
    }
    return arr;
}
const people = [50, 55, 112, 235, 365];
const totalPrice = publicBusFare(people);
